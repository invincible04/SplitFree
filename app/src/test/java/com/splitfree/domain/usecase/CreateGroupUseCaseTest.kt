...
class CreateGroupUseCaseTest {
    ...
    @Test
    fun `invoke creates group with correct fields`() =
        runBlocking {
    ...
    @Test
    fun `invoke saves group to repository`() =
        runBlocking {
            useCase("Test")
    ...
    @Test
    fun `invoke encrypts and publishes group_meta event`() =
        runBlocking {
            useCase("Test")
    ...
    @Test
    fun `invoke with custom relays uses them`() =
        runBlocking {
    ...
    @Test(expected = IllegalArgumentException::class)
    fun `invoke rejects name over 100 chars`() =
        runBlocking {
    ...
    @Test
    fun `invoke accepts name at 100 chars`() =
        runBlocking {
