...
class JoinGroupUseCaseTest {
    ...
    private fun buildUri(
        ...
        val k = java.util.Base64.getUrlEncoder().withoutPadding().encodeToString(groupKey.toByteArray())
    ...
    fun `invoke rejects missing k parameter`() = runBlocking {
        val g = java.util.Base64.getUrlEncoder().withoutPadding().encodeToString("test".toByteArray())
