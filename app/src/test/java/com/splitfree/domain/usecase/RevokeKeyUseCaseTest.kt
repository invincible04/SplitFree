...
class RevokeKeyUseCaseTest {
    ...
    private val group = Group(groupId, "Test", "", oldPubkey, 1000, listOf(oldPubkey, "cc".repeat(32)), listOf("wss://r"))
    ...
    fun setup() {
        ...
        useCase = RevokeKeyUseCase(identity, groupRepo, encryption, signer, eventDao, outboxDao, throttler)
    }
