...
class NostrEventBranchTest {
    ...
    fun `fromJson with all fields`() {
        val json = """{"id":"abc","pubkey":"def","created_at":123,"kind":1,"tags":[["g","x"]],"content":"hello","sig":"sig1"}"""
    ...
    fun `toJson and fromJson round-trip`() {
        val original = NostrEvent("id1", pubHex, 12345, 30078, listOf(listOf("g", "grp"), listOf("t", "expense")), "content", "sig1")
