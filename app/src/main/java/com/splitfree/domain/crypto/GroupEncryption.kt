...
/**
 * Handles group symmetric encryption using NIP-44 v2.
 *
 * Derives a deterministic secp256k1 keypair from the shared group key using
 * HMAC-SHA256 as a KDF, then uses Nip44 for encrypt/decrypt.
 */
@Singleton
...
constructor() {
    ...
    private fun deriveValidPrivateKey(ikm: ByteArray, context: String): ByteArray {
